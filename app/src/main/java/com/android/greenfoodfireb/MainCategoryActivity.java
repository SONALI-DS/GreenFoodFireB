...
public class MainCategoryActivity extends AppCompatActivity {
    ...
    private void setCategories() {
        ...
        FoodCategory foodCategory4 = new FoodCategory("Waffle",R.drawable.ic_chicken);
        ...
        FoodCategoryAdapter foodCategoryAdapter = new FoodCategoryAdapter(data, MainCategoryActivity.this, new FoodCategoryAdapter.OnCategoryClick() {
            @Override
        ...
        recyclerCategories.setLayoutManager(new LinearLayoutManager( MainCategoryActivity.this, RecyclerView.HORIZONTAL,false));
    ...
    private void setFoodItem(int pos){
        ...
        recyclerItems.setLayoutManager(new LinearLayoutManager( MainCategoryActivity.this, RecyclerView.HORIZONTAL,false));
