package com.android.greenfoodfireb.widget;
...
public class SNavigationDrawer extends RelativeLayout{
    ...
    //Listeners
    private com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.OnHamMenuClickListener onHamMenuClickListener;
    private com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.OnMenuItemClickListener onMenuItemClickListener;
    private com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.DrawerListener drawerListener;
    ...
    public com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.OnHamMenuClickListener getOnHamMenuClickListener() {
        return onHamMenuClickListener;
    }

    public void setOnHamMenuClickListener(com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.OnHamMenuClickListener onHamMenuClickListener) {
        this.onHamMenuClickListener = onHamMenuClickListener;
    }

    public com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.OnMenuItemClickListener getOnMenuItemClickListener() {
        return onMenuItemClickListener;
    }

    public void setOnMenuItemClickListener(com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.OnMenuItemClickListener onMenuItemClickListener) {
        this.onMenuItemClickListener = onMenuItemClickListener;
    }

    public com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.DrawerListener getDrawerListener() {
        return drawerListener;
    }

    public void setDrawerListener(com.shrikanthravi.customnavigationdrawer2.widget.SNavigationDrawer.DrawerListener drawerListener) {
